...
export class ContenuSchema extends BaseModel {
   ...
   static get columnMapping() {
      return {
         ...
         en_tete_contenu_fr_mobile: { type: types.TEXT },
         en_tete_contenu_mg_mobile: { type: types.TEXT },
         ...
         expose_des_motifs_contenu_fr_mobile: { type: types.TEXT },
         expose_des_motifs_contenu_mg_mobile: { type: types.TEXT },
